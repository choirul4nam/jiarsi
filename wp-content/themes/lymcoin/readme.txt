...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Lymcoin'.
Please install and activate it before starting to use the theme Lymcoin.
Also the theme supports many popular plugins such as 'Revolution Slider', 'WPBakery Page Builder', 'WooCommerce'
and many more.


III. Documentation

Theme documentation is available on http://lymcoin.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Lymcoin is Fontello.
