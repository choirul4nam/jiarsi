			...
			<div class="team_member_details">
				...
				foreach ($meta_box as $k=>$v) {
					if (!empty($v['details']) && !empty($meta[$k])) {
						?><div class="team_member_details_<?php echo esc_attr($k); ?>"><span class="team_member_details_label"><?php echo esc_html($v['title']); ?>: </span><span class="team_member_details_value"><a href="mailto:<?php echo esc_attr($meta[$k]); ?>"><?php echo esc_html($meta[$k]); ?></a></span></div><?php
					}
				}
				?>
			</div>
